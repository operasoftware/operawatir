module OperaWatir::Compat::Elements
  ...
  class Del < NonControlElement; end
  ...
  class Hidden < NonControlElement; end
  class Ins < NonControlElement; end
  class Li < NonControlElement; end
  class Map < NonControlElement; end
  class Meta < NonControlElement; end
  class Ol < NonControlElement; end
  ...
  class TBody < NonControlElement; end
  class THead < NonControlElement; end
  class Table < NonControlElement; end
  class Td < NonControlElement; end
  class Tr < NonControlElement; end
